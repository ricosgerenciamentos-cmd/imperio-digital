...
const products = [
  ...
  { id:1, title:'Assistência Técnica: Como começar do zero e fazer seus primeiros serviços', cat:'Negócios', intent:'ganhar', tag:'Mais vendido', img:'/assistencia-celular.png', price:'R$ 14,00', old:'R$ 47,00', link:'https://pay.kiwify.com.br/PjRqOei', desc:'Aprenda a iniciar no ramo de assistência técnica com um guia direto e prático.' },
  { id:2, title:'Barbearia do Zero: Aprenda a começar e conquistar seus primeiros clientes', cat:'Negócios', intent:'ganhar', tag:'Top vendas', img:'/barbearia.png', price:'R$ 13,00', old:'R$ 47,00', link:'https://pay.kiwify.com.br/ynz7UXJ', desc:'Do planejamento à gestão para começar uma barbearia de destaque.' },
  { id:3, title:'Vendas Digitais para Iniciantes: Aprenda a vender online passo a passo', cat:'Negócios', intent:'ganhar', tag:'Digital', img:'/vendas-digitais.png', price:'R$ 14,00', old:'R$ 47,00', link:'https://pay.kiwify.com.br/tAqlMeI', desc:'Estratégias simples para vender todos os dias pela internet.' },
  { id:4, title:'Reeducação Alimentar: Comece com hábitos simples para melhorar sua saúde', cat:'Saúde', intent:'saude', tag:'Saúde', img:'/reeducacao-alimentar.png', price:'R$ 13,00', old:'R$ 47,00', link:'https://pay.kiwify.com.br/0SAithY', desc:'Mude seus hábitos e transforme sua saúde com passos práticos.' },
